...
-----
  ...
  + 3 power heaters (*1 bed and up to 2 extruder heaters*) with PWM power control up to 50A (*MOSFET params 30A without cooling, llimited by the used connector and the width of the cooper on the PCB see bellow*)
